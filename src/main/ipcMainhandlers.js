...
ipcMain.handle('userReg', async (_, employeeID, firstName, lastName, idNumber, email, department, position) => {
  try {
...
ipcMain.handle('clientReg', async (_, firstName, middleName, lastName, idNumber, address, email, phoneNumber, packageType, idCopy) => {
  try {
